...
def main(argv):
    ...
    if src is None:
        ...
        print("Usage:")
        print(
            "mat_mask_operations.py [image_path -- default ./tmb_175897_6011.jpg] [G -- grayscale]")
        return -1
    ...
    kernel = np.array([[-1, -1, -1],
                       [-1, 16, -1],
                       [-1, -1, -1]], np.float32)  # kernel should be floating point type
